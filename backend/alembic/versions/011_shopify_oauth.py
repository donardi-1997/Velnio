...
def upgrade() -> None:
    ...
    op.create_index("ix_shopify_oauth_states_workspace_id", "shopify_oauth_states", ["workspace_id"], unique=False)
    op.create_index("ix_shopify_oauth_states_user_id", "shopify_oauth_states", ["user_id"], unique=False)
