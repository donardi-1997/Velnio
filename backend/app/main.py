...
from app.api.routes import auth, workspace, stores, products, ai, angles, landings, credits, billing, dashboard, shopify, campaigns, product_import, enrichment, visual_assets, publish, tracking, variants, performance, demo
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Velnio", "version": "0.4.0"}
